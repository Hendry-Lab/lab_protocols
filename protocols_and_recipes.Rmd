...
-   Add 500 µl / L for final concentration of 50 µg / mL
...
To make 1L of 1X TAE, add 20 mL 50X TAE to 980 mL distilled H2O
...
autoclave on liquid cycle for 20min
...
# Nitrofurantoin (NFT) stocks (50 mg/mL)

1.  In the hood, make solution of:
...
# Naladoxic Acid (NA) stocks (30 mg/mL)

1.  In the hood, using a 50 mL conical, make a solution of:

    -   900 mg Naladoxic Acid
...
1.  From -80°C/current plate, plate *Pseudomonas* strains/individual colonies on KB + NA (15 μg/mL) + NFT (50 μg/mL) plates.
2.  Incubate for 24-72 hours at 28°C.

Day 0: Overnights of Pseudomonas

1.  Pipette 10 mL of KB + NA (15 μg/mL) + NFT (50 μg/mL) media in 15 mL culture tube.
...
7.  Transfer 100 μL of sample to a blank cuvette.
...
6.  Make serial dilutions (2 technical replicate/sample) in 96 well plate using multichannel pipette.
    -   450 μL buffer and 50 μL sample/dilution.
7.  Plate serial dilutions on KB + NA (15 μg/mL) + NFT (50 μg/mL) plates.
    -   Each sample should be plates undiluted, 10^-1^, and 10^-2^

    -   100 μL per plate
8.  Allow plates to dry then flip upside and incubate at 28C for 48 hrs.
...
6.  Dispense 900 μL of sterile 20% glycerol in each cryotube.
7.  Dispense 100 μL of overnight culture to its designated cryotube.
...
# Pseudomonas Overnight Liquid Cultures

*Note: the inoculation should be performed in the hood.*

1.  Pipette 10 mL of KB + NA (15 μg/mL) + NFT (50 μg/mL) media in 15 mL culture tube.

2.  Transfer a colony of *Pseudomonas* from plate to media using either a sterile flamed loop or sterile pipette tip.

3.  Incubate in benchtop shaker at 28C overnight (\~18 hrs).

# **Tryptic Soy Agar** (TSA) Media (500 mL)
...
1.  Measure 500 ml DI water into a 1 L glass media bottle.
2.  Add ingredients in order above and swirl to mix.
3.  Autoclave on liquid run for 30 mins.
4.  Place in waterbath at 56ºC until cool enough to pour.
5.  If adding antibiotics/antifungals, wait until bottle is temperature of a warm cup of tea before adding.
